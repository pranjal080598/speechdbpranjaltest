...
from librecval.extract_i3 import I3RecordingExtractor
...
class Command(BaseCommand):
    help = "imports Îethka Îabi recordings into the database"
    ...
    def handle(
        ...
        **options,
        ...
        if sessions_dir is None:
            sessions_dir = settings.I3_AUDIO_DIR
    ...
    def _handle_store_django(self, sessions_dir, logger) -> None:
        ...
        recording_extractor = I3RecordingExtractor()
